...
<%@page import="modelo.Tipos_samgre" %>
        ...
        <div class="modal-body">
             <form action="sr_estudiante" method="post" class="form-group">
               <label for="lbl_id" ><b>ID</b></label>
                ...
                <input type="text" name="txt_correo" id="txt_correo" class="form-control" placeholder="Ejemplo: cjimenez@umg.edu.gt" required>
                <label for="lbl_fn" ><b>Nacimiento</b></label>
                <input type="date"  name="txt_fn" id="txt_fn" class="form-control" required>
                <label for="lbl_tipos_sangre" ><b>Sangre</b></label>
                <select name="drop_tipos_sangre" id="drop_tipos_sangre" class="form-control">
                    <% 
                        Tipos_sangre tipos_sangre = new Tipos_sangre();
                        HashMap<String,String> drop = puesto.drop_tipos_sangre();
